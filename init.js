...
arr.add('javascript:(void(function(){var c = document.getElementById(' + '\'fishstar_content\'' + '); var ls = document.links; for(var i=0;i<ls.length;i++) if (/.+\d{7}\.html/.test(ls[i].href)) c.value += c.value + ls[i].href + ' + '\'\\r\\n\'' + ';})())', 'Show Links');
