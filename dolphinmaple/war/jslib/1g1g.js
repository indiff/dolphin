		var defaultDisplayText = document.getElementById("displayText_1g1g").innerHTML;
		var playerUrl = "http://www.1g1g.com/";
		...
		document.write('<param name="movie" value="jslib/commander.swf"/>');	
		document.write('<param name="allowScriptAccess" value ="always" />');	
		document.write('<EMBED src="jslib/commander.swf" allowScriptAccess="always" width="100%" height="100%" name="commander1g1g"  type="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" />');	
		...
		var controller_t = document.getElementById("controller_t");
		...
		function controllerInit(){
			...
			controller_t.onclick = onControllerClick;
		}
		...
		function controllerReset(){
			...
			controller_t.style.cursor = "pointer";
			playerState = "stop";		
		}
		...
		function playerEventDispatcher(type, body){
			if(type == "connect"){					
				...
				controller_t.style.cursor = "default";
			}
