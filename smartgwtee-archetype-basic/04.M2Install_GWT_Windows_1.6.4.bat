set GWT_VERSION=1.6.4
set GWT_WINDOWS_HOME=D:\GWT\gwt-windows-%GWT_VERSION%
...
call mvn	install:install-file "-Dfile=%GWT_WINDOWS_HOME%\gwt-dev-windows.jar"   ^
		-DgroupId=com.google.gwt ^
		-DartifactId=gwt-dev-windows ^
		-Dversion=%GWT_VERSION%  ^
		-Dpackaging=jar  ^
		-DgeneratePom=true  ^
		-DcreateChecksum=true
