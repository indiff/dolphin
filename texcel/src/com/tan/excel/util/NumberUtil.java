...
public class NumberUtil {
	...
	public static void main(String[] args) {
		BigDecimal rate1 = new BigDecimal(.25);
		BigDecimal rate2 = new BigDecimal(.65);
		BigDecimal rate3 = new BigDecimal(.1);
		
		
		BigDecimal result = new BigDecimal(0);
		
		BigDecimal utd1 = new BigDecimal(.25);
		BigDecimal utd2 = new BigDecimal(.65);
		BigDecimal utd3 = new BigDecimal(.1);
		
		
		result.add(utd1.multiply(rate1));
//		result.add(utd2.multiply(rate2));
//		result.add(utd3.multiply(rate3));
		
		TanUtil.println(result);
//		TanUtil.println(result.add(utd1.multiply(rate1)));
	}
}