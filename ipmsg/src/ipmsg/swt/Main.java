...
public class Main {
	...
	public void showSetupDialog() {
		...
		dialog.setInitValue(properties.getProperty("userName"), properties.getProperty("groupName"),
		...
		if (dialog.open()) {
			...
			try {
				...
				// Messengerオブジェクト�?開�?
				messenger = new Messenger(this.userName, this.userName, this.groupName, this.sign, this);
				messenger.login();
				messenger.start();
	...
	private void initComponents() {
		...
		table = new Table(sash, SWT.BORDER | SWT.V_SCROLL | SWT.FULL_SELECTION);
	 ...
	 *            ホスト名
	 */
	public void addMember(final String userName, final String groupName, final String host, final String signature) {
	...
	/**
	 * SWT�?PMessengerの起動クラス�? 以下�?起動オプションを指定可能です�?
	 * <ul>
